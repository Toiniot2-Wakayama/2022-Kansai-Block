...
#define LINEAVOID_DEFAULT 125
#define LINEAVOID_LONG 125
#define LINESTOP 25
#define LINETIME_LR 750
...
int motionWrite(int motionDir) {
    ...
    if (lastMotion[0] == 1 && motionDir == 3 && gT[1] < LINETIME_LR) {
        motionLongFlag = 1;
    }
    else if (lastMotion[0] == 3 && motionDir == 1 && gT[1] < LINETIME_LR) {
        motionLongFlag = 1;
    }
    else {
        motionLongFlag = 0;
