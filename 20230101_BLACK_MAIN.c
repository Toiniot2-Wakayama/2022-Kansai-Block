...
#define LINE_LOW 670
#define BALL_LOW 400
#define BALL_FAR_MEDIUM 875
#define BALL_MEDIUM_NEAR 1000
#define HIGH2 0.875
    ...
    case 3:
        ...
        while (TRUE) {
                ...
                if (sumLeft - sumRight < 0) {
                    ...
                    if ((-1 * DIF_LR < sumLeft - sumRight) == FALSE) {
                        ...
                        default:
                            ...
                            moveNatural(KP2 * (sumLeft - sumRight) * -1, KP2 * (sumLeft - sumRight), KP2 * (sumLeft - sumRight), KP2 * (sumLeft - sumRight) * -1);
                            break;
                        }
            ...
            */
            ...
            //もし距離センサの値が異常なら距離センサ制御を区別する変数を1にする
            //★★★200から1000に修正
            if(highValue > 1000 || highValue2 = 0){
                distanceEscape = 1;
            }

            //モーター速度を調整する
            disMotor = (highValue2 - highValue) * 0.1;
            ...
            if(timer >= 3){
                if(distanceEscape != 1){
                    ...
                    case 9:
                        //中心に戻る
                        move(disMotor * -1, disMotor, disMotor, disMotor * -1, BALL);
                        continue;

                    case 8:
                        //中心に戻る
                        move(disMotor, disMotor * -1, disMotor * -1, disMotor, BALL);
                        continue;
                    }
                    continue;
                }

                else if(distanceEscape = 1){
                    distanceEscape = 0;
                }
                continue;
            }
